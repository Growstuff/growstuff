...
ActiveRecord::Schema.define(version: 20170410080449) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.string   "categories",    limit: 255, array: true
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "planting_weather_logs", force: :cascade do |t|
    t.integer  "planting_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.json     "weather_data"
  ...
  add_index "planting_weather_logs", ["planting_id"], name: "index_planting_weather_logs_on_planting_id", using: :btree
