  ...
  describe 'POST create' do
    ...
    describe 'with valid params' do
      ...
      describe 'attaches the photo to a planting' do
        before do
          post :create,
               params: { photo: { source_id: photo.source_id, source: 'flickr' }, type: 'planting', id: planting.id }
        end
        it { expect(flash[:alert]).not_to be_present }
      ...
      it 'attaches the photo to a harvest' do
        post :create,
             params: { photo: { source_id: photo.source_id, source: 'flickr' }, type: 'harvest', id: harvest.id }
      ...
      it "doesn't attach photo to a comment" do
        ...
        expect do
          post :create,
               params: { photo: { source_id: photo.source_id, source: 'flickr' }, type: 'comment', id: comment.id }
