...
describe HarvestsController do
  ...
  describe 'POST create' do
    describe 'with valid params' do
      it 'creates a new Harvest' do
        expect { post :create, params: { harvest: valid_attributes } }.to change(Harvest, :count).by(1)
      end
  ...
  describe 'PUT update' do
    describe 'with valid params' do
      ...
      it 'updates the requested harvest' do
        ...
        expect {
          ...
          harvest.reload
        }.to change(harvest, :crop_id).to(new_crop.id)
      end
    ...
    describe 'not my planting' do
      ...
      describe 'does not save planting_id' do
        before do
          put :update,
              params: { id: harvest.to_param, harvest: valid_attributes.merge(planting_id: not_my_planting.id) }
        end
  ...
  describe 'DELETE destroy' do
    it 'destroys the requested harvest' do
      harvest = Harvest.create! valid_attributes
      expect { delete :destroy, params: { id: harvest.to_param } }.to change(Harvest, :count).by(-1)
    end
