...
describe 'Growstuff::OauthSignupAction' do
  before { @action = Growstuff::OauthSignupAction.new }
      ...
      context 'who has used oauth' do
        before do
          ...
          @existing_authentication =
            @existing_member.authentications.create(
              provider: 'facebook', uid: '123545', name: "John Testerson's Brother", member_id: @existing_member.id
            )
