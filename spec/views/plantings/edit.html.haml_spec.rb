...
describe 'plantings/edit' do
  before do
    @member = FactoryBot.create(:member, login_name: 'right', email: 'right@example.com')
    ...
    @planting = assign(:planting, FactoryBot.create(:planting, garden: @garden, crop: @tomato, owner: @member))
  end
