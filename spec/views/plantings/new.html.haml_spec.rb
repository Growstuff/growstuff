...
describe 'plantings/new' do
  before do
    ...
    @planting = FactoryBot.create(:planting, garden: @garden_a, crop: @crop2, owner: @member)
  ...
  context 'logged in' do
    ...
    it 'selects a garden given in a param' do
      assert_select 'input',
                    id: "planting_garden_id_#{@garden_z.id}", type: 'radio', value: @garden_z.id, checked: 'checked'
    end
  end
end
