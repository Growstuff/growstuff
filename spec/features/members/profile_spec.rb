  ...
  shared_examples 'member activity' do
    ...
    context 'plantings' do
      ...
      let(:growing_planting) do
        FactoryBot.create :planting, crop: crop, owner: member, planted_at: Time.zone.today
      end

      let(:harvesting_planting) do
        FactoryBot.create :planting, crop: crop, owner: member, planted_at: 51.days.ago
      end

      let(:super_late_planting) do
        FactoryBot.create :planting, crop: crop, owner: member, planted_at: 260.days.ago
      end
