...
describe 'Harvesting a crop', :js, :elasticsearch do
  context 'signed in' do
    ...
    context 'Viewing a harvest' do
      let(:existing_harvest) { create :harvest, crop: maize, owner: member, harvested_at: Time.zone.today }
      let!(:existing_planting) { create :planting, crop: maize, owner: member, planted_at: Time.zone.yesterday }

      before { visit harvest_path(existing_harvest) }
