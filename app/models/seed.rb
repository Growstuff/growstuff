class Seed < ApplicationRecord
  ...
  belongs_to :parent_planting,
             class_name: 'Planting', foreign_key: 'parent_planting_id', optional: true, inverse_of: :child_seeds # parent
  has_many :child_plantings,
           class_name: 'Planting', foreign_key: 'parent_seed_id', dependent: :nullify, inverse_of: :parent_seed # children
  ...
  validates :days_until_maturity_min, allow_nil: true, numericality: { only_integer: true, greater_than_or_equal_to: 0 }
