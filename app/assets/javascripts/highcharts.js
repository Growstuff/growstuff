...
(function (S, M) {
  "object" === typeof module && module.exports
    ? (module.exports = S.document ? M(S) : M)
    : (S.Highcharts = M(S));
  ...
  (function (a) {
    ...
    var E = a.charts,
      D = a.doc,
      H = a.win;
    a.error = function (p, f) {
      p = a.isNumber(p)
        ? "Highcharts error #" + p + ": www.highcharts.com/errors/" + p
        : p;
      if (f) throw Error(p);
    ...
    a.Fx.prototype = {
      dSetter: function () {
        ...
        if (1 === r) l = this.toD;
          ...
          for (; n--; )
            (w = parseFloat(a[n])),
              (l[n] = isNaN(w) ? f[n] : r * parseFloat(f[n] - w) + w);
        else l = f;
      ...
      run: function (p, f, l) {
        var r = this,
          ...
          e = function () {
            for (var h = 0; h < a.timers.length; h++)
      ...
      step: function (p) {
        ...
        n.attr && !n.element
          ...
          ? ((this.now = this.end),
            ...
            l && w && w.call(n),
            (p = !1))
          : ((this.pos = r.easing((f - this.startTime) / u)),
      ...
      initPath: function (p, f, l) {
        function r(a) {
          ...
          for (k = a.length; k--; )
            (b = "M" === a[k] || "L" === a[k]),
              ...
              b &&
                c &&
                a.splice(k + 1, 0, a[k + 1], a[k + 2], a[k + 1], a[k + 2]);
        }
        function n(a, b) {
          for (; a.length < c; ) {
            a[0] = b[c - a.length];
        ...
        function w(a, k) {
          for (var e = (c - a.length) / d; 0 < e && e--; )
            (b = a.slice().splice(a.length / B - d, d * B)),
              (b[0] = k[c - d - e * d]),
              m && ((b[d - 6] = b[d - 2]), (b[d - 5] = b[d - 1])),
              [].splice.apply(a, [a.length / B, 0].concat(b)),
              z && e--;
        }
        f = f || "";
        var u,
    ...
    a.attr = function (p, f, l) {
      ...
      a.isString(f)
        ? a.defined(l)
          ? p.setAttribute(f, l)
          : p && p.getAttribute && (r = p.getAttribute(f))
        : a.defined(f) &&
          a.isObject(f) &&
    ...
    a.getTZOffset = function (p) {
      ...
      return (
        6e4 *
        ((f.hcGetTimezoneOffset && f.hcGetTimezoneOffset(p)) ||
          f.hcTimezoneOffset ||
          0)
      );
    };
    ...
    a.normalizeTickInterval = function (p, f, l, r, n) {
      ...
      for (
        ...
        r < f.length &&
        !((u = f[r]),
        (n && u * l >= p) || (!n && w <= (f[r] + (f[r + 1] || f[r])) / 2));
        r++
      );
      return (u = a.correctFloat(
        u * l,
    ...
    a.numberFormat = function (p, f, l, r) {
      ...
      -1 === f
        ...
        ? f &&
          ...
          ((u = f + +h[1]),
          0 <= u
            ? ((h[0] = (+h[0]).toExponential(u).split("e")[0]), (f = u))
            : ((h[0] = h[0].split(".")[0] || 0),
              (p = 20 > f ? (h[0] * Math.pow(10, h[1])).toFixed(f) : 0),
              (h[1] = 0)))
        : (f = 2);
      e = (
        Math.abs(h[1] ? h[0] : p) + Math.pow(10, -Math.max(f, w) - 1)
      ).toFixed(f);
      w = String(a.pInt(e));
    ...
    a.getStyle = function (p, f, l) {
      ...
      if ((p = H.getComputedStyle(p, void 0)))
        (p = p.getPropertyValue(f)),
          a.pick(l, "opacity" !== f) && (p = a.pInt(p));
      return p;
    };
    ...
    a.grep = function (p, f) {
      return (a.filterPolyfill || Array.prototype.filter).call(p, f);
    };
    ...
    a.offset = function (a) {
      ...
      return {
        top: a.top + (H.pageYOffset || f.scrollTop) - (f.clientTop || 0),
    ...
    a.addEvent = function (p, f, l) {
      ...
      p.hcEvents &&
        !Object.prototype.hasOwnProperty.call(p, "hcEvents") &&
        ((n = {}),
        a.objectEach(p.hcEvents, function (a, e) {
          n[e] = a.slice(0);
        }),
        (p.hcEvents = n));
      ...
      function n() {
        ...
        p.nodeName &&
          ...
          a.objectEach(e, function (a, c) {
            if (u[c]) for (m = u[c].length; m--; ) r(c, u[c][m]);
          }));
      }
      var w,
        u = p.hcEvents,
    ...
    a.fireEvent = function (p, f, l, r) {
      ...
      var w, u;
      l = l || {};
      if (D.createEvent && (p.dispatchEvent || p.fireEvent))
        (n = D.createEvent("Events")),
          n.initEvent(f, !0, !0),
          a.extend(n, l),
          p.dispatchEvent ? p.dispatchEvent(n) : p.fireEvent(f, n);
      else if (n)
        for (
          n = n[f] || [],
            w = n.length,
          ...
          (u = n[f]) && !1 === u.call(p, l) && l.preventDefault();
    ...
    a.animate = function (p, f, l) {
      ...
      a.isObject(l) ||
        ((e = arguments),
        (l = { duration: e[2], easing: e[3], complete: e[4] }));
      ...
      a.objectEach(f, function (e, m) {
        ...
        w = null;
        "d" === m
          ? ((u.paths = u.initPath(p, p.d, f.d)),
            (u.toD = f.d),
            (r = 0),
            (w = 1))
          : p.attr
          ? (r = p.attr(m))
          : ((r = parseFloat(a.getStyle(p, m)) || 0),
            "opacity" !== m && (n = "px"));
        w || (w = e);
        ...
        if (this[0])
          return p[0]
            ? (new a[a.isString(p[0]) ? p.shift() : "Chart"](
              ...
              this)
            : E[a.attr(this[0], "data-highcharts-chart")];
      });
  })(M);
  (function (a) {
    var E = a.each,
    ...
    a.Color.prototype = {
      ...
      init: function (l) {
        ...
        if (
          (this.input = l =
            this.names[l && l.toLowerCase ? l.toLowerCase() : ""] || l) &&
          l.stops
        )
  ...
  (function (a) {
    ...
    c(E.prototype, {
      ...
      animate: function (y, g, b) {
        ...
        0 !== g.duration
          ? (b && (g.complete = b), p(this, y, g))
          : (this.attr(y, null, b), g.step && g.step.call(this));
        return this;
      },
      colorGradient: function (y, g, b) {
        ...
        y.radialGradient
          ? (O = "radialGradient")
          : y.linearGradient && (O = "linearGradient");
        O &&
          ((k = y[O]),
          (z = v.gradients),
          (m = y.stops),
          ...
          z[t]
            ? (J = z[t].attr("id"))
            : ((k.id = J = a.uniqueKey()),
              (z[t] = h = v.createElement(O).attr(k).add(v.defs)),
              (h.radAttr = e),
              (h.stops = []),
              d(m, function (y) {
                0 === y[1].indexOf("rgba")
                  ? ((c = a.color(y[1])), (L = c.get("rgb")), (A = c.get("a")))
                  : ((L = y[1]), (A = 1));
                y = v
                  .createElement("stop")
                  .attr({ offset: y[0], "stop-color": L, "stop-opacity": A })
                  .add(h);
                h.stops.push(y);
              })),
          (x = "url(" + v.url + "#" + J + ")"),
      ...
      applyTextOutline: function (y) {
        ...
        if ((k = y[0]) && "none" !== k && a.svg) {
          ...
          for (e = y.length; e--; )
            (v = y[e]),
              "highcharts-text-outline" === v.getAttribute("class") &&
                b(y, g.removeChild(v));
          q = g.firstChild;
          d(y, function (a, y) {
            0 === y &&
          ...
          : (F(
              ...
              function (y, g) {
                ...
                this.symbolName &&
                  ...
                  (k || (this.symbolAttr(a), (k = !0)), (O = !0));
                !this.rotation ||
                  ("x" !== g && "y" !== g) ||
                  (this.doTransform = !0);
                O ||
                  ((q = this[g + "Setter"] || this._defaultSetter),
                  q.call(this, y, g, c),
                  this.shadows &&
                    /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(
                      g
                    ) &&
                    this.updateShadows(g, y, q));
              },
              this
            ),
            this.afterSetters());
      ...
      css: function (a) {
        ...
        e &&
          ...
          (k = this.textWidth =
            ...
            a.width &&
            "auto" !== a.width &&
            "text" === v.nodeName.toLowerCase() &&
            g(a.width)),
          (this.styles = a),
          k && !L && this.renderer.forExport && delete a.width,
          K && !L
            ? n(this.element, a)
            : ((q = function (a, y) {
          ...
          : k &&
            a.push(
              "rotate(" +
                k +
                " " +
                G(this.rotationOriginX, q.getAttribute("x"), 0) +
                " " +
                G(this.rotationOriginY, q.getAttribute("y") || 0) +
                ")"
            );
      ...
      align: function (a, g, v) {
        ...
        if (a) {
          if (
            ((this.alignOptions = a), (this.alignByTranslate = g), !v || C(v))
          )
            (this.alignTo = y = v || "renderer"),
              b(k, this),
              k.push(this),
              (v = null);
        } else
      ...
      getBBox: function (a, g) {
        ...
        u(z) &&
          ((A = z.toString()),
          -1 === A.indexOf("\x3c") && (A = A.replace(/[0-9]/g, "0")),
          (A += ["", g || 0, O, q && q.width, q && q.textOverflow].join()));
        A && !a && (y = m[A]);
        if (!y) {
          if (k.namespaceURI === this.SVG_NS || b.forExport) {
            try {
              (h =
                this.fakeTS &&
                function (a) {
                  d(k.querySelectorAll(".highcharts-text-outline"), function (
                    y
                  ) {
                    y.style.display = a;
                  });
          ...
          b.isSVG &&
            ...
            g &&
              ((y.width =
                Math.abs(b * Math.sin(v)) + Math.abs(a * Math.cos(v))),
              (y.height =
                Math.abs(b * Math.cos(v)) + Math.abs(a * Math.sin(v)))));
          if (A && 0 < y.height) {
      ...
      destroy: function () {
        ...
        a.clipPath &&
          c &&
          (d(c.querySelectorAll("[clip-path],[CLIP-PATH]"), function (g) {
            g
              .getAttribute("clip-path")
              .match(RegExp('[("]#' + a.clipPath.element.id + '[)"]')) &&
        ...
        if (!a) this.destroyShadows();
          ...
          for (v = 1; v <= q; v++)
            (c = k.cloneNode(0)),
              ...
              b &&
                (f(c, "height", Math.max(f(c, "height") - d, 0)),
                (c.cutHeight = d)),
              g
                ? g.element.appendChild(c)
                : k.parentNode && k.parentNode.insertBefore(c, k),
              y.push(c);
          this.shadows = y;
        }
        return this;
      ...
      titleSetter: function (a) {
        ...
        g ||
          ((g = m.createElementNS(this.SVG_NS, "title")),
          this.element.appendChild(g));
        g.firstChild && g.removeChild(g.firstChild);
        g.appendChild(
          m.createTextNode(String(G(a), "").replace(/<[^>]*>/g, ""))
        );
      },
        ...
        if (k) {
          ...
          for (z = b.length - 1; 0 <= z && !q; z--)
            if (((y = b[z]), (k = y.zIndex), (e = !u(k)), y !== d))
              ...
              else if (g(k) <= a || (e && (!u(a) || 0 <= a)))
                c.insertBefore(d, b[z + 1] || null), (q = !0);
    ...
    E.prototype["stroke-widthSetter"] = E.prototype.strokeSetter = function (
      ...
      this.stroke && this["stroke-width"]
        ? (E.prototype.fillSetter.call(this, this.stroke, "stroke", b),
    ...
    c(D.prototype, {
      ...
      init: function (a, g, b, v, c, k) {
        ...
        this.alignedObjects = [];
        this.url =
          (x || N) && m.getElementsByTagName("base").length
            ? R.location.href
                .replace(/#.*?$/, "")
                .replace(/<[^>]*>/g, "")
                .replace(/([\('\)])/g, "\\$1")
        ...
        this.createElement("desc")
          .add()
          .element.appendChild(
            m.createTextNode("Created with Highcharts 6.0.4")
          );
        ...
        x &&
          ...
          g(),
          (this.unSubPixelFix = H(R, "resize", g)));
      },
      getStyle: function (a) {
        return (this.style = c(
          {
      ...
      getSpanWidth: function (a, g) {
        ...
        !L &&
          this.forExport &&
          (b = this.measureSpanWidth(g.firstChild.data, a.styles));
        return b;
      },
      ...
      buildText: function (a) {
        var b = a.element,
          ...
          p = function (a) {
            var c;
            c = /(px|em)$/.test(a && a.style.fontSize)
              ? a.style.fontSize
              : w || v.style.fontSize || 12;
            return l
              ? g(l)
              : v.fontMetrics(c, a.getAttribute("style") ? a : b).h;
          },
          K = function (a) {
        ...
        if (R !== a.textCache) {
          ...
          q || C || u || B || -1 !== y.indexOf(" ")
            ? ((z = /<.*class="([^"]+)".*>/),
                    ...
                    if (" " !== g) {
                      ...
                      if (B) {
                        ...
                        var O = [],
                          ...
                          G = a.rotation;
                        for (
                          u && (J = v.applyEllipsis(a, e, g, B));
                          !u && x && (d.length || O.length);

                        )
                          (a.rotation = 0),
                            (l = v.getSpanWidth(a, e)),
                            (g = l > B),
                            void 0 === J && (J = g),
                            g && 1 !== d.length
              ...
              J && a.attr("title", a.textStr),
              x && x.removeChild(b),
              C && a.applyTextOutline && a.applyTextOutline(C))
            : b.appendChild(m.createTextNode(K(y)));
        }
      },
      ...
      arc: function (a, g, b, v, c, d) {
        t(a)
          ? ((v = a), (g = v.y), (b = v.r), (a = v.x))
          : (v = { innerR: v, start: c, end: d });
      ...
      rect: function (a, g, b, v, c, d) {
        ...
        a = t(a)
          ...
          : void 0 === a
          ? {}
          : { x: a, y: g, width: Math.max(b, 0), height: Math.max(v, 0) };
      ...
      image: function (a, g, b, v, d) {
        ...
        k.element.setAttributeNS
          ? k.element.setAttributeNS("http://www.w3.org/1999/xlink", "href", a)
          : k.element.setAttribute("hc-svg-href", a);
        return k;
      },
      symbol: function (a, g, b, v, k, q) {
        var e = this,
          ...
          t =
            u(g) &&
            L &&
            L.call(this.symbols, Math.round(g), Math.round(b), v, k, q),
          x,
          F;
        L
          ? ((y = this.path(t)),
            y.attr("fill", "none"),
            c(y, { symbolName: A, x: g, y: b, width: v, height: k }),
            q && c(y, q))
          : h &&
            ((x = a.match(z)[1]),
            (y = this.image(x)),
            (y.imgwidth = G(J[x] && J[x].width, q && q.width)),
            (y.imgheight = G(J[x] && J[x].height, q && q.height)),
            (F = function () {
            ...
            d(["width", "height"], function (a) {
              y[a + "Setter"] = function (a, g) {
                ...
                this[g] = a;
                u(v) &&
                  (this.element && this.element.setAttribute(g, v),
                  this.alignByTranslate ||
                    ((b[c] = ((this[g] || 0) - v) / 2), this.attr(b)));
              };
            }),
            u(g) && y.attr({ x: g, y: b }),
            (y.isImg = !0),
            u(y.imgwidth) && u(y.imgheight)
              ? F()
      ...
      symbols: {
        ...
        arc: function (a, g, b, v, c) {
          var k = c.start,
            ...
            e = c.end - 0.001;
          b = c.innerR;
          v = G(c.open, 0.001 > Math.abs(c.end - c.start - 2 * Math.PI));
          var y = Math.cos(k),
            z = Math.sin(k),
            h = Math.cos(e),
            e = Math.sin(e);
          c = 0.001 > c.end - k - Math.PI ? 0 : 1;
          d = [
            "M",
            a + d * y,
            g + q * z,
        ...
        callout: function (a, g, b, v, c) {
          ...
          q && q > b
            ...
            : q && 0 > q
            ? c > g + k && c < g + v - k
              ? e.splice(33, 3, "L", a, c + 6, a - 6, c, a, c - 6, a, g + d)
              : e.splice(33, 3, "L", a, v / 2, q, c, a, v / 2, a, g + d)
            : c && c > v && q > a + k && q < a + b - k
            ? e.splice(
                23,
                3,
            ...
            : c &&
              ...
              q > a + k &&
              q < a + b - k &&
              e.splice(3, 3, "L", q - 6, g, q, g - 6, q + 6, g, b - d, g);
          return e;
        },
      },
      ...
      fontMetrics: function (a, b) {
        a =
          a ||
          (b && b.style && b.style.fontSize) ||
          (this.style && this.style.fontSize);
        a = /px/.test(a)
          ? g(a)
          : /em/.test(a)
          ? parseFloat(a) * (b ? this.fontMetrics(null, b.parentNode).f : 16)
          : 12;
      ...
      label: function (g, b, k, e, z, h, m, A, L) {
        ...
        O = function () {
          var a = t.element.style,
            g = {};
          F =
            (void 0 === C || void 0 === f || w) && u(t.textStr) && t.getBBox();
          J.width = (C || F.width || 0) + 2 * B + l;
          J.height = (f || F.height || 0) + 2 * B;
          P = B + y.fontMetrics(a && a.fontSize, t).b;
          p &&
            (x ||
              ((J.box = x = y.symbols[e] || r ? y.symbol(e) : y.rect()),
              x.addClass(
                ("button" === L ? "" : "highcharts-label-box") +
                  (L ? " highcharts-" + L + "-box" : "")
              ),
              x.add(J),
              (a = K()),
              (g.x = a),
              (g.y = (A ? -P : 0) + a)),
            (g.width = Math.round(J.width)),
            (g.height = Math.round(J.height)),
            x.attr(c(g, R)),
            (R = {}));
        };
        N = function () {
          ...
          u(C) &&
            F &&
            ("center" === w || "right" === w) &&
            (a += { center: 0.5, right: 1 }[w] * (C - F.width));
          if (a !== t.x || g !== t.y)
            t.attr("x", a), void 0 !== g && t.attr("y", g);
          t.x = a;
          t.y = g;
        };
        T = function (a, g) {
  ...
  (function (a) {
    ...
    l(a.SVGElement.prototype, {
      ...
      htmlUpdateTransform: function () {
        if (this.added) {
          var a = this.renderer,
            ...
            n = { left: 0, center: 0.5, right: 1 }[x],
            t = this.styles;
          H(b, { marginLeft: d, marginTop: z });
          this.shadows &&
            f(this.shadows, function (a) {
              H(a, { marginLeft: d + 1, marginTop: z + 1 });
            });
          this.inverted &&
          ...
          if ("SPAN" === b.tagName) {
            var l = this.rotation,
              u = e(this.textWidth),
              q = t && t.whiteSpace,
              A = [l, x, b.innerHTML, this.textWidth, this.textAlign].join();
            A !== this.cTT &&
              ((t = a.fontMetrics(b.style.fontSize).b),
              p(l) && this.setSpanRotation(l, n, t),
              H(b, { width: "", whiteSpace: q || "nowrap" }),
              b.offsetWidth > u &&
      ...
      setSpanRotation: function (a, b, d) {
        ...
        c[k + (r ? "Origin" : "-origin")] = c.transformOrigin =
          100 * b + "% " + d + "px";
        H(this.element, c);
      },
    ...
    l(h.prototype, {
      ...
      html: function (a, b, k) {
        ...
        c.xSetter = c.ySetter = c.alignSetter = c.rotationSetter = function (
          a,
          b
        ) {
          "align" === b && (b = "textAlign");
        ...
        c.attr({ text: a, x: Math.round(b), y: Math.round(k) }).css({
              ...
              if (((b = a.div), !b)) {
                ...
                f(k.reverse(), function (a) {
                  ...
                  l(a, {
                    ...
                    on: function () {
                      k[0].div && c.on.apply({ element: k[0].div }, arguments);
                      return a;
                    },
                    translateXSetter: e,
                    translateYSetter: e,
  ...
  (function (a) {
    ...
    function D() {
      ...
      f.hcMakeTime = function (a, b, d, e, h, m) {
        var c;
        u
          ? ((c = f.UTC.apply(0, arguments)), (c += p(c)))
          : (c = new f(a, b, l(d, 1), l(e, 0), l(h, 0), l(m, 0)).getTime());
        return c;
      };
  ...
  (function (a) {
    ...
    a.Tick.prototype = {
      addLabel: function () {
        ...
        a.isDatetimeAxis &&
          c &&
          (z = w.dateTimeLabelFormats[c.higherRanks[m] || c.unitName]);
        this.isFirst = b;
        this.isLast = k;
      ...
      handleOverflow: function (a) {
        var f = this.axis,
          ...
          m = l(
            f.labelRight,
            Math.max(f.isRadial ? 0 : f.pos + f.len, h - m[1])
          ),
          c = this.label,
          b = this.rotation,
        ...
        if (b || !1 === n.overflow)
          0 > b && e - k * z < d
            ? (p = Math.round(e / Math.cos(b * r) - d))
            : 0 < b &&
              e + k * z > m &&
              (p = Math.round((h - e) / Math.cos(b * r)));
        else if (
          ((h = e + (1 - k) * z),
          e - k * z < d
            ? (I = a.x + I * (1 - k) - d)
          ...
          I < B &&
            "center" === f.labelAlign &&
            (a.x += x * (B - I - k * (B - Math.min(z, I)))),
          z > I || (f.autoRotation && (c.styles || {}).width))
        )
          p = I;
        p &&
          ((t.width = p),
          (n.style || {}).textOverflow || (t.textOverflow = "ellipsis"),
          c.css(t));
      },
      getPosition: function (a, f, l, e) {
        ...
        return {
          x: a
            ? h.translate(f + l, null, null, e) + h.transB
            : h.left +
              h.offset +
              (h.opposite
                ? ((e && m.oldChartWidth) || m.chartWidth) - h.right - h.left
                : 0),
          y: a
            ? d - h.bottom + h.offset - (h.opposite ? h.height : 0)
            : d - h.translate(f + l, null, null, e) - h.transB,
        };
      },
      getLabelPosition: function (a, f, l, e, h, m, d, c) {
        var b = this.axis,
          k = b.transA,
          z = b.reversed,
          B = b.staggerLines,
          ...
          x = h.y,
          u =
            e || b.reserveSpaceDefault
              ? 0
              : -b.labelOffset * ("center" === b.labelAlign ? 0.5 : 1);
        D(x) ||
          (x =
            0 === b.side
              ? l.rotation
              ...
              : 2 === b.side
              ? n.y + 8
              : Math.cos(l.rotation * r) * (n.y - l.getBBox(!1, 0).height / 2));
      ...
      renderGridLine: function (a, f, l) {
        ...
        if (
          !a &&
          m &&
          (a = e.getPlotLinePath(c + k, m.strokeWidth() * l, a, !0))
        )
          m[this.isNew ? "attr" : "animate"]({ d: a, opacity: f });
      },
        ...
        b &&
          ...
          z &&
            ((this.mark = k = m
              ...
              .add(e.axisGroup)),
            k.attr({ stroke: h, "stroke-width": n })),
          k[z ? "attr" : "animate"]({
            d: this.getMarkPath(B, a, b[0], k.strokeWidth() * u, e.horiz, m),
            opacity: f,
          }));
      },
      renderLabel: function (a, f, u, e) {
        var h = this.axis,
          m = h.horiz,
          d = h.options,
          c = this.label,
        ...
        c &&
          p(B) &&
          ((c.xy = a = this.getLabelPosition(B, a, c, m, b, h, e, k)),
  ...
  var V = (function (a) {
    ...
    a.extend(G.prototype, {
      ...
      init: function (a, b) {
        ...
        v.side =
          b.side || (v.horiz ? (v.opposite ? 0 : 2) : v.opposite ? 1 : 3);
        v.setOptions(b);
        var c = this.options,
          d = c.type;
        ...
        v.crosshair = C(
          c.crosshair,
          q(a.options.tooltip.crosshairs)[g ? 0 : 1],
          !1
        );
        b = v.options.events;
        -1 === k(v, a.axes) &&
          (g ? a.axes.splice(a.xAxis.length, 0, v) : a.axes.push(v),
          a[v.coll].push(v));
        v.series = v.series || [];
        a.inverted &&
          !v.isZAxis &&
            ...
            if (a.isXAxis)
              (c = g.xData),
                c.length &&
                  ((g = p(c)),
                  (k = H(c)),
                  B(g) || g instanceof Date || ((c = b(c, B)), (g = p(c))),
                  (a.dataMin = Math.min(C(a.dataMin, c[0], g), g)),
                  (a.dataMax = Math.max(C(a.dataMax, c[0], k), k)));
            else if (
              (g.getExtremes(),
              (k = g.dataMax),
              (g = g.dataMin),
              n(g) &&
                ...
                (a.dataMax = Math.max(C(a.dataMax, k), k))),
              n(d) && (a.threshold = d),
      ...
      translate: function (a, b, c, d, k, e) {
        ...
        b
          ? ((a = (a * v + q - m) / h + d), k && (a = g.lin2val(a)))
          : (k && (a = g.val2lin(a)),
            (a = B(d)
              ? v * (a - d) * h + q + v * m + (B(e) ? h * e : 0)
              : void 0));
        return a;
      },
      ...
      getPlotLinePath: function (a, b, c, d, k) {
        var g = this.chart,
          ...
          e,
          h,
          m = (c && g.oldChartHeight) || g.chartHeight,
          z = (c && g.oldChartWidth) || g.chartWidth,
          A;
        e = this.transB;
        ...
        B(k)
          ? this.horiz
            ? ((e = q),
              (h = m - this.bottom),
              (a = c = t(a, v, v + this.width)))
            : ((a = v),
              (c = z - this.right),
              (e = h = t(e, q, q + this.height)))
          : ((A = !0), (d = !1));
        return A && !d
          ? null
          : g.renderer.crispLine(["M", a, e, "L", c, h], b || 1);
      },
      getLinearTickPositions: function (a, b, c) {
        var g,
          v = l(Math.floor(b / a) * a);
        c = l(Math.ceil(c / a) * a);
        var d = [],
          k;
        l(v + a) === v && (k = 20);
      ...
      getMinorTickPositions: function () {
        ...
        if (m && m / d < a.len / 3)
          if (a.isLog)
            e(this.paddedTicks, function (g, b, v) {
              b &&
                k.push.apply(k, a.getLogTickPositions(d, v[b - 1], v[b], !0));
            });
      ...
      adjustForMinRange: function () {
        ...
        c - b < this.minRange &&
          ...
          (d = (t - c + b) / 2),
          (d = [b - d, C(a.min, b - d)]),
          k && (d[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin),
          (b = H(d)),
          (c = [b + t, C(a.max, b + t)]),
          k && (c[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax),
          (c = p(c)),
          c - b < t && ((d[0] = c - t), (d[1] = C(a.min, c - t)), (b = H(d))));
        this.min = b;
        this.max = c;
      },
      getClosest: function () {
        ...
        this.categories
          ...
          : e(this.series, function (g) {
              var b = g.closestPointRange,
                v = g.visible || !g.chart.options.chart.ignoreHiddenSeries;
              !g.noSharedTooltip &&
                n(b) &&
                v &&
                (a = n(a) ? Math.min(a, b) : b);
            });
        return a;
      },
      nameToX: function (a) {
        ...
        0 < this.names.length &&
          ...
          e(this.series || [], function (g) {
            ...
            e(g.points, function (b, v) {
              ...
              b.options &&
                ((c = a.nameToX(b)),
                void 0 !== c && c !== b.x && ((b.x = c), (g.xData[v] = c)));
            });
          }));
      },
      setAxisTranslation: function (a) {
        ...
        if (A || m || c)
          (d = g.getClosest()),
            h
              ? ((k = h.minPointOffset), (q = h.pointRangePadding))
              : e(g.series, function (a) {
                  var b = m
                    ? 1
                    : A
                    ? C(a.options.pointRange, d, 0)
                    : g.axisPointRange || 0;
                  a = a.options.pointPlacement;
                  c = Math.max(c, b);
                  g.single ||
                    ((k = Math.max(k, I(a) ? 0 : b / 2)),
                    (q = Math.max(q, "on" === a ? 0 : b)));
                }),
            (h = g.ordinalSlope && d ? g.ordinalSlope / d : 1),
            (g.minPointOffset = k *= h),
            (g.pointRangePadding = q *= h),
            (g.pointRange = Math.min(c, b)),
            A && (g.closestPointRange = d);
        a && (g.oldTransA = z);
        g.translationSlope = g.transA = z =
          g.options.staticScale || g.len / (b + q || 1);
      ...
      setTickInterval: function (g) {
        ...
        D = C(b.userMax, k.max);
        t
          ? ((b.linkedParent = d[b.coll][k.linkedTo]),
            (d = b.linkedParent.getExtremes()),
            (b.min = C(d.min, d.dataMin)),
            (b.max = C(d.max, d.dataMax)),
            k.type !== b.linkedParent.options.type && a.error(11, 1))
          : (!I &&
              n(p) &&
              (b.dataMin >= p
                ? ((r = p), (f = 0))
                : b.dataMax <= p && ((w = p), (x = 0))),
            (b.min = C(N, r, b.dataMin)),
            (b.max = C(D, w, b.dataMax)));
        q &&
        ...
        b.range &&
          n(b.max) &&
          ((b.userMin = b.min = N = Math.max(b.dataMin, b.minFromRange())),
          (b.userMax = D = b.max),
          (b.range = null));
        m(b, "foundExtremes");
        b.beforePadding && b.beforePadding();
        b.adjustForMinRange();
        !(G || b.axisPointRange || b.usePercentage || t) &&
          n(b.min) &&
          n(b.max) &&
          (h = b.max - b.min) &&
          (!n(N) && f && (b.min -= h * f), !n(D) && x && (b.max += h * x));
        B(k.softMin) && !B(b.userMin) && (b.min = Math.min(b.min, k.softMin));
        ...
        I &&
          n(b.dataMin) &&
          ((p = p || 0),
          !n(N) && b.min < p && b.dataMin >= p
            ? (b.min = p)
            : !n(D) && b.max > p && b.dataMax <= p && (b.max = p));
        b.tickInterval =
          b.min === b.max || void 0 === b.min || void 0 === b.max
            ? 1
            : t && !F && u === b.linkedParent.options.tickPixelInterval
            ...
            : C(
                ...
                this.tickAmount
                  ...
                  : void 0,
                G ? 1 : ((b.max - b.min) * u) / Math.max(b.len, u)
              );
        A &&
          !g &&
      ...
      setTickPositions: function () {
        ...
        !b &&
          ...
          b.length > this.len &&
            ((b = [b[0], b.pop()]), b[0] === b[1] && (b.length = 1)),
      ...
      unsquish: function () {
        ...
        b
          ? (t =
              ...
              (n(h)
                ? [h]
                : k < C(a.autoRotationLimit, 80) && a.autoRotation)) &&
            e(t, function (a) {
              var b;
              if (a === h || (a && -90 <= a && 90 >= a))
                (z = x(Math.abs(m.h / Math.sin(w * a)))),
                  (b = z + Math.abs(a / 360)),
                  b < A && ((A = b), (q = a), (d = z));
            })
          : a.step || (d = x(m.h));
      ...
      renderUnsquish: function () {
        ...
        else if (h && ((f = { width: m + "px" }), !t))
          for (f.textOverflow = "clip", l = c.length; !q && l--; )
            if (((B = c[l]), (m = d[B].label)))
              m.styles && "ellipsis" === m.styles.textOverflow
                ? m.css({ textOverflow: "clip" })
                : d[B].labelLength > h && m.css({ width: h + "px" }),
                m.getBBox().height > this.len / c.length - (A.h - A.f) &&
                  (m.specCss = { textOverflow: "ellipsis" });
        z.rotation &&
          ((f = {
            width:
              (F > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : a.chartHeight) +
              "px",
          }),
          t || (f.textOverflow = "ellipsis"));
        if (
          (this.labelAlign = k.align || this.autoLabelAlign(this.labelRotation))
        )
      ...
      addTitle: function (a) {
        ...
        this.axisTitle ||
          ...
          (this.axisTitle = b
            ...
            .attr({ zIndex: 7, rotation: d.rotation || 0, align: k })
      ...
      getOffset: function () {
        ...
        a.axisGroup ||
          ...
          (a.axisGroup = c
            ...
            .addClass("highcharts-" + this.coll.toLowerCase() + " " + (r || ""))
            .add(w)),
          (a.labelGroup = c
            .g("axis-labels")
            .attr({ zIndex: u.zIndex || 7 })
            .addClass(
              "highcharts-" + a.coll.toLowerCase() + "-labels " + (r || "")
            )
            .add(w)));
        A || a.isLinked
          ? (e(k, function (b, c) {
        ...
        B &&
          ...
          x &&
            !1 !== B.reserveSpace &&
            ((a.titleOffset = f = a.axisTitle.getBBox()[
              h ? "height" : "width"
            ]),
            (F = B.offset),
            (l = n(F) ? 0 : C(B.margin, h ? 5 : 10))));
        a.renderLine();
        ...
        p[m] = Math.max(
          p[m],
          a.axisTitleMargin + f + I * a.offset,
          l,
          A && k.length && K ? K[0] + I * a.offset : 0
        );
      ...
      render: function () {
        ...
        if (b.hasData() || h)
          b.minorTickInterval &&
            ...
            m.length &&
              ...
              u &&
                (0 === b.min || b.single) &&
                (x[-1] || (x[-1] = new F(b, -1, null, !0)), x[-1].render(-1))),
            n &&
              e(m, function (d, g) {
                ...
                0 === g % 2 &&
                  d < b.max &&
                  w <= b.max + (c.polar ? -u : u) &&
                  (l[d] || (l[d] = new a.PlotLineOrBand(b)),
                  (r = d + u),
                  (l[d].options = {
                    from: k ? q(r) : r,
                    to: k ? q(w) : w,
            ...
            b._addedPlotLB ||
              (e((d.plotLines || []).concat(d.plotBands || []), function (a) {
          ...
          A(
            function () {
              for (b = d.length; b--; )
                a[d[b]] &&
                  !a[d[b]].isActive &&
                  (a[d[b]].destroy(), delete a[d[b]]);
            },
            a !== l && c.hasRendered && g ? g : 0
          );
        });
        G &&
          (G[G.isPlaced ? "animate" : "attr"]({
        ...
        z &&
          ...
          B(d.y)
            ? (z[z.isNew ? "attr" : "animate"](d), (z.isNew = !1))
            : (z.attr("y", -9999), (z.isNew = !0)));
      ...
      destroy: function (a) {
        ...
        for (g in b.plotLinesAndBandsGroups)
          b.plotLinesAndBandsGroups[g] = b.plotLinesAndBandsGroups[g].destroy();
        t(b, function (a, c) {
      ...
      drawCrosshair: function (a, b) {
        ...
        this.crosshair && !1 !== (n(b) || !g)
          ? (g
              ? n(b) && (k = this.isXAxis ? b.plotX : this.len - b.plotY)
              : (k =
                  a &&
                  (this.horiz
                    ? a.chartX - this.pos
            ...
            n(c)
              ? ((b = this.categories && !this.isRadial),
                q ||
                  ((this.cross = q = this.chart.renderer
                    .path()
                    .addClass(
                  ...
                  d.dashStyle && q.attr({ dashstyle: d.dashStyle })),
                q.show().attr({ d: c }),
                b && !d.width && q.attr({ "stroke-width": this.transA }),
                (this.cross.e = a))
              : this.hideCrosshair())
          : this.hideCrosshair();
      },
  ...
  (function (a) {
    ...
    E.prototype.getTimeTicks = function (a, d, c, b) {
      var k = [],
        ...
        q;
      if (f(d)) {
        x[D.hcSetMilliseconds](
          t >= h.second ? 0 : C * Math.floor(x.getMilliseconds() / C)
        );
        if (t >= h.second)
          x[D.hcSetSeconds](
            t >= h.minute ? 0 : C * Math.floor(x.getSeconds() / C)
          );
        if (t >= h.minute)
          x[D.hcSetMinutes](
            t >= h.hour ? 0 : C * Math.floor(x[D.hcGetMinutes]() / C)
          );
        if (t >= h.hour)
          x[D.hcSetHours](
            t >= h.day ? 0 : C * Math.floor(x[D.hcGetHours]() / C)
          );
        if (t >= h.day)
          x[D.hcSetDate](
            t >= h.month ? 1 : C * Math.floor(x[D.hcGetDate]() / C)
          );
        t >= h.month &&
          (x[D.hcSetMonth](
            t >= h.year ? 0 : C * Math.floor(x[D.hcGetMonth]() / C)
          ),
          (n = x[D.hcGetFullYear]()));
        ...
        D.hcHasTimeZone &&
          ((q =
            (!B || !!D.hcGetTimezoneOffset) &&
            (c - d > 4 * h.month || w(d) !== w(c))),
          (N = w(x)),
          (x = new D(d + N)));
        B = x.getTime();
        for (d = 1; B < c; )
          k.push(B),
            (B =
              t === h.year
                ...
                : !q || (t !== h.day && t !== h.week)
                ? q && t === h.hour
                  ? u(n, b, A, F + d * C, 0, 0, N) - N
                  : B + t * C
                : u(n, b, A + d * C * (t === h.day ? 1 : 7))),
            d++;
        k.push(B);
        t <= h.hour &&
          1e4 > k.length &&
    ...
    E.prototype.normalizeTimeTickInterval = function (a, d) {
      ...
      for (
        ...
        (b = h[d[0]]),
        (k = d[1]),
        c[e + 1] && a <= (b * k[k.length - 1] + h[c[e + 1][0]]) / 2);
        e++
      );
  ...
  (function (a) {
    ...
    E.prototype.getLogTickPositions = function (a, r, n, w) {
      ...
      if (0.5 <= a)
        (a = Math.round(a)), (d = this.getLinearTickPositions(a, r, n));
      else if (0.08 <= a)
        for (
          var e = Math.floor(r),
            c,
          ...
          for (b = l.length, c = 0; c < b && !B; c++)
            (k = m(h(e) * l[c])),
              k > r && (!w || z <= n) && void 0 !== z && d.push(z),
              z > n && (B = !0),
              (z = k);
      else
        (r = h(r)),
          (n = h(n)),
          (a = w ? this.getMinorTickInterval() : l.tickInterval),
          (a = f(
            "auto" === a ? null : a,
            this._minorAutoInterval,
            ((l.tickPixelInterval / (w ? 5 : 1)) * (n - r)) /
              ((w ? e / this.tickPositions.length : e) || 1)
          )),
          (a = p(a, null, D(a))),
          (d = H(this.getLinearTickPositions(a, r, n), m)),
  ...
  (function (a, E) {
    ...
    a.PlotLineOrBand.prototype = {
      render: function () {
        var f = this,
          ...
          G = l ? "bands" : "lines",
          g = e.log2lin;
        e.isLog && ((k = g(k)), (b = g(b)), (z = g(z)));
        r
          ? ((t = { stroke: C, "stroke-width": m.width }),
            m.dashStyle && (t.dashstyle = m.dashStyle))
          : l &&
            (C && (t.fill = C),
            m.borderWidth &&
              ((t.stroke = m.borderColor),
              (t["stroke-width"] = m.borderWidth)));
        A.zIndex = N;
        G += "-" + N;
        (C = e.plotLinesAndBandsGroups[G]) ||
          (e.plotLinesAndBandsGroups[G] = C = F.g("plot-" + G)
            .attr(A)
            .add());
    ...
    a.extend(E.prototype, {
      getPlotBandPath: function (a, e) {
        ...
        if (m && h)
          for (
            a && ((k = m.toString() === h.toString()), (b = 0)), a = 0;
            a < m.length;
            a += 6
          )
            c && h[a + 1] === m[a + 1]
  ...
  (function (a) {
    ...
    a.Tooltip.prototype = {
      ...
      move: function (a, e, d, c) {
        var b = this,
          ...
          h =
            ...
            !b.isHidden &&
            (1 < Math.abs(a - k.x) || 1 < Math.abs(e - k.y)),
      ...
      getAnchor: function (a, e) {
        ...
        this.followPointer &&
          e &&
          (void 0 === e.chartX && (e = c.pointer.normalize(e)),
          (d = [e.chartX - c.plotLeft, e.chartY - k]));
        d ||
          (D(a, function (a) {
            x = a.series.yAxis;
            n = a.series.xAxis;
      ...
      getPosition: function (a, e, d) {
        var c = this.chart,
          ...
          C = function (a, c, d, g) {
            ...
            g < b || g > c - b
              ? (e = !1)
              : (k[a] = g < d / 2 ? 1 : g > c - d / 2 ? c - d - 2 : g - d / 2);
            return e;
          },
          p = function (a) {
            var b = f;
      ...
      refresh: function (a, e) {
        ...
        c.enabled &&
          (clearTimeout(this.hideTimer),
          (this.followPointer = w(k)[0].series.tooltipOptions.followPointer),
          (h = this.getAnchor(k, e)),
          (e = h[0]),
          (b = h[1]),
          !m || (k.series && k.series.noSharedTooltip)
            ? (m = k.getLabelConfig())
            : (D(k, function (a) {
                a.setState("hover");
          ...
          (m = d.call(m, this)),
          (x = k.series),
          (this.distance = n(x.tooltipOptions.distance, 16)),
          !1 === m
            ? this.hide()
            : ((d = this.getLabel()),
              this.isHidden && d.attr({ opacity: 1 }).show(),
              this.split
                ? this.renderSplit(m, w(a))
                : (c.style.width ||
                    d.css({ width: this.chart.spacingBox.width }),
                  d.attr({ text: m && m.join ? m.join("") : m }),
                  d
                    .removeClass(/highcharts-color-[\d]+/g)
                    .addClass(
                      "highcharts-color-" + n(k.colorIndex, x.colorIndex)
                    ),
                  d.attr({
          ...
          if (!1 !== a) {
            ...
            t ||
              (z.tt = t = k
                ...
                .addClass("highcharts-tooltip-box " + A)
                .attr({
                  padding: f.padding,
                  r: f.borderRadius,
            ...
            e.isHeader
              ? ((l = a.height),
                (q = Math.max(
                  0,
                  Math.min(e.plotX + b.plotLeft - q / 2, b.chartWidth - q)
                )))
              : (q = e.plotX + b.plotLeft - n(f.distance, 16) - q);
            0 > q && (h = !1);
            a =
              (e.series && e.series.yAxis && e.series.yAxis.pos) +
              (e.plotY || 0);
            a -= b.plotTop;
            c.push({
      ...
      getDateFormat: function (a, m, d, c) {
        ...
        for (h in e) {
          ...
          if (f[h] && b.substr(f[h]) !== "01-01 00:00:00.000".substr(f[h]))
            break;
          "week" !== h && (l = h);
        }
        h && (k = c[h]);
      ...
      getXDateFormat: function (a, e, d) {
        ...
        return (
          (c ? this.getDateFormat(c, a.x, d.options.startOfWeek, e) : e.day) ||
          e.year
        );
      },
      ...
      bodyFormatter: function (a) {
        return l(a, function (a) {
          ...
          ).call(a.point, d[(a.point.formatPrefix || "point") + "Format"]);
        });
      },
    };
  })(M);
  (function (a) {
    ...
    a.Pointer.prototype = {
      ...
      getChartCoordinatesFromPoint: function (a, c) {
        ...
        if (d && b)
          return c
            ? { chartX: d.len + d.pos - k, chartY: b.len + b.pos - a.plotY }
            : { chartX: k + d.pos, chartY: a.plotY + b.pos };
      },
      ...
      runPointActions: function (b, c) {
        ...
        if (h && (h !== d.hoverPoint || (k && k.isHidden))) {
          ...
          c &&
            ...
            !k.isHidden &&
            ((h = k.getAnchor([{}], b)),
            k.updatePosition({ plotX: h[0], plotY: h[1] }));
        this.unDocMouseMove ||
      ...
      drag: function (a) {
        ...
        (F && F.touch) ||
          ...
          (this.hasDragged = Math.sqrt(
            Math.pow(G - d, 2) + Math.pow(g - e, 2)
          )),
          10 < this.hasDragged &&
            ((A = b.isInsidePlot(G - f, g - l)),
            b.hasCartesianSeries &&
              ...
              (this.selectionMarker = F = b.renderer
                .rect(f, l, h ? 1 : n, m ? 1 : q, 0)
                .attr({
                  fill:
                    c.selectionMarkerFill ||
                    p("#335cad").setOpacity(0.25).get(),
            ...
            F &&
              h &&
              ((d -= G),
              F.attr({ width: Math.abs(d), x: (0 < d ? 0 : d) + G })),
            F &&
              m &&
              ((d = e - g),
              F.attr({ height: Math.abs(d), y: (0 < d ? 0 : d) + g })),
      ...
      setDOMEvents: function () {
        ...
        a.unbindDocumentMouseUp ||
          (a.unbindDocumentMouseUp = E(d, "mouseup", b.onDocumentMouseUp));
        a.hasTouch &&
  ...
  (function (a) {
    ...
    H(a.Pointer.prototype, {
      ...
      pinchTranslateDirection: function (a, f, l, p, e, h, m, d) {
        ...
        f < u.min
          ? ((f = u.min), (v = !0))
          : f + x > u.max && ((f = u.max - x), (v = !0));
        v
          ? ((F -= 0.8 * (F - m[b][0])), q || (g -= 0.8 * (g - m[b][1])), l())
          : (m[b] = [F, g]);
        C || ((h[b] = w - r), (h[n] = x));
        h = C ? 1 / t : t;
        e[n] = x;
      ...
      pinch: function (a) {
        var n = this,
          ...
          k =
            1 === h &&
            ((n.inClass(a.target, "highcharts-tracker") && r.runTrackerClick) ||
              n.runChartClick),
          z = {};
        1 < h && (n.initiated = !0);
        ...
        "touchstart" === a.type
          ? (D(e, function (a, b) {
            ...
            (n.res = !0))
          : n.followTouchMove && 1 === h
          ? this.runPointActions(n.normalize(a))
          : u.length &&
            (c ||
              (n.selectionMarker = c = H({ destroy: f, touch: !0 }, r.plotBox)),
            n.pinchTranslate(u, e, b, c, z, m),
            (n.hasPinched = d),
            n.scaleGroups(b, z),
      ...
      touch: function (f, n) {
        ...
        1 === f.touches.length
          ? ((f = this.normalize(f)),
            (e = p.isInsidePlot(f.chartX - p.plotLeft, f.chartY - p.plotTop)) &&
            !p.openMenu
  ...
  (function (a) {
    ...
    a.Legend.prototype = {
      ...
      colorizeItem: function (a, c) {
        ...
        h &&
          (l &&
            h.isMarker &&
            ((t = a.pointAttribs()), c || (t.stroke = t.fill = f)),
          h.attr(t));
      },
      positionItem: function (a) {
        ...
        (a = a.legendGroup) &&
          a.element &&
          a.translate(c ? e : this.legendWidth - e - 2 * b - 4, d);
        h && ((h.x = e), (h.y = d));
      },
          ...
          f(
            ...
            function (d) {
              var k = d.checkbox,
                h;
              k &&
                ((h = c + e + k.y + (this.scrollOffset || 0) + 3),
                D(k, {
      ...
      renderItem: function (a) {
        ...
        G ||
          ...
          (a.legendItem = G = b
            .text("", r ? h + f : -f, this.baseline || 0, P)
            .css(n(a.visible ? m : l))
            .attr({ align: r ? "left" : "right", zIndex: 2 })
            .add(a.legendGroup)),
          this.baseline ||
            ((h = m.fontSize),
            (this.fontMetrics = b.fontMetrics(h, G)),
            (this.baseline = this.fontMetrics.f + 3 + F),
            G.attr("y", this.baseline)),
          (this.symbolHeight = d.symbolHeight || this.fontMetrics.f),
          v.drawLegendSymbol(this, a),
          this.setItemEvents && this.setItemEvents(a, G, P),
          L && this.createCheckboxForItem(a));
        this.colorizeItem(a, a.visible);
        m.width ||
          G.css({ width: (d.itemWidth || d.width || c.spacingBox.width) - u });
        this.setText(a);
        b = G.getBBox();
        m = a.checkboxOffset = d.itemWidth || a.legendItemWidth || b.width + u;
        this.itemHeight = b = Math.round(
          a.legendItemHeight || b.height || this.symbolHeight
        );
        e &&
          this.itemX - t + m > (q || c.spacingBox.width - 2 * t - d.x) &&
          ((this.itemX = t),
          (this.itemY += F + this.lastLineHeight + A),
        ...
        e
          ? (this.itemX += m)
          : ((this.itemY += F + b + A), (this.lastLineHeight = b));
        this.offsetWidth =
          q ||
          Math.max(
            (e ? this.itemX - t - (a.checkbox ? 0 : p) : m) + t,
            this.offsetWidth
          );
      },
      getAllItems: function () {
        ...
        f(this.chart.series, function (c) {
          var b = c && c.options;
          c &&
            w(b.showInLegend, p(b.linkedTo) ? !1 : void 0, !0) &&
            (a = a.concat(
          ...
          f(
            ...
            function (k, h) {
              k.test(e) &&
                ...
                (b[r[h]] = Math.max(
                  b[r[h]],
                  b.legend[(h + 1) % 2 ? "legendHeight" : "legendWidth"] +
                    [1, -1, -1, 1][h] * d[h % 2 ? "x" : "y"] +
                    w(d.margin, 12) +
                    c[h] +
                    (0 === h ? b.titleOffset + b.options.title.margin : 0)
                ));
            }
          );
      },
      render: function () {
        ...
        a.lastItemY = 0;
        k ||
          ((a.group = k = b.g("legend").attr({ zIndex: 7 }).add()),
          (a.contentGroup = b.g().attr({ zIndex: 1 }).add(k)),
        ...
        0 < l &&
          0 < x &&
          (p[p.isNew ? "attr" : "animate"](
            p.crisp.call(
              {},
              { x: 0, y: 0, width: l, height: x },
              p.strokeWidth()
            )
          ),
          (p.isNew = !1));
        ...
        m &&
          ...
          /(lth|ct|rth)/.test(a.getAlignment()) &&
            (b = n(b, { y: b.y + c.titleOffset + c.options.title.margin })),
          k.align(n(t, { width: l, height: x }), !0, b));
      ...
      handleOverflow: function (a) {
        ...
        A.length = 0;
        a > b && !1 !== t.enabled
          ? ((this.clipHeight = l = Math.max(b - 20 - this.titleHeight - m, 0)),
            ...
            n ||
              ((n = c.clipRect = d.clipRect(0, m, 9999, 0)),
      ...
      scroll: function (a, c) {
        ...
        0 < a &&
          ...
          this.down
            .attr({ fill: a === d ? h.inactiveColor : h.activeColor })
    ...
    a.LegendSymbolMixin = {
      ...
      drawLineMarker: function (a) {
        ...
        b &&
          !1 !== b.enabled &&
          ((c = Math.min(w(b.radius, h), h)),
          0 === this.symbol.indexOf("url") &&
            ((b = n(b, { width: e, height: e })), (c = 0)),
          (this.legendSymbol = b = f
            .symbol(this.symbol, d / 2 - c, a - c, 2 * c, 2 * c, b)
            .addClass("highcharts-point")
            .add(m)),
          (b.isMarker = !0));
      },
    };
    (/Trident\/7\.0/.test(h.navigator.userAgent) || l) &&
      m(a.Legend.prototype, "positionItem", function (a, c) {
        var b = this,
          d = function () {
    ...
    d(P.prototype, {
      ...
      init: function (b, c) {
        ...
        for (g in d.plotOptions)
          d.plotOptions[g].tooltip = (k[g] && t(k[g].tooltip)) || void 0;
      ...
      redraw: function (c) {
        ...
        h && q.options.enabled && (q.render(), (this.isDirtyLegend = !1));
        f && this.getStacks();
        v &&
          m(g, function (a) {
            a.updateNames();
      ...
      setTitle: function (a, b, c) {
        ...
        e = g.title = t(
          {
            style: { color: "#333333", fontSize: g.isStock ? "16px" : "18px" },
          },
          g.title,
          a
        );
      ...
      layOutTitles: function (a) {
        ...
        m(
          ...
          function (a) {
            ...
            c &&
              ((q = k.style.fontSize),
              (q = g.fontMetrics(q, c).b),
              c
                .css({ width: (k.width || e.width + k.widthAdjust) + "px" })
                .align(d({ y: a + q }, k), !1, "spacingBox"),
              k.floating ||
                k.verticalAlign ||
                (b = Math.ceil(b + c.getBBox(k.useHTML).height)));
          },
          this
        );
        ...
        if (b)
          for (; c && c.style; )
            c.hcOrigStyle && (a.css(c, c.hcOrigStyle), delete c.hcOrigStyle),
              c.hcOrigDetached &&
                (f.body.removeChild(c), (c.hcOrigDetached = !1)),
              (c = c.parentNode);
        else
          for (; c && c.style; ) {
            f.body.contains(c) ||
      ...
      getContainer: function () {
        ...
        z(e) && u[e] && u[e].hasRendered && u[e].destroy();
      ...
      setSize: function (c, d, g) {
        ...
        (c ? D : e)(
          k.container,
          { width: k.chartWidth + "px", height: k.chartHeight + "px" },
          c
        );
        k.setChartSize(!0);
      ...
      setChartSize: function (a) {
        ...
        this.plotHeight = v = Math.max(
          0,
          Math.round(g - f - this.marginBottom)
        );
        ...
        this.clipBox = {
          ...
          height: Math.max(
            0,
            Math.floor(this.plotSizeY - Math.max(d, q[2]) / 2 - c)
          ),
        };
        a ||
      ...
      drawChartBox: function () {
        ...
        f = { fill: f || "none" };
        if (q || g["stroke-width"])
          (f.stroke = a.borderColor), (f["stroke-width"] = q);
        ...
        l &&
          (h
            ? h.animate(n)
            : (this.plotBGImage = b.image(l, A, F, t, x).add()));
        p
          ? p.animate({ width: z.width, height: z.height })
      ...
      propFromSeries: function () {
        ...
        m(["inverted", "angular", "polar"], function (k) {
          ...
          for (g = d && d.length; !e && g--; )
            (c = G[d[g].type]) && c.prototype[k] && (e = !0);
          a[k] = e;
        });
      },
      linkSeries: function () {
        ...
        m(b, function (b) {
          ...
          I(c) &&
            ...
            (b.linkedParent = c),
            (b.visible = q(b.options.visible, c.options.visible, b.visible)));
        });
      },
      ...
      isReadyToRender: function () {
        var a = this;
        return v || L != L.top || "complete" === f.readyState
          ? !0
    ...
    a.Point.prototype = {
      init: function (a, h, f) {
        ...
        a.options.colorByPoint
          ? ((h = a.options.colors || a.chart.options.colors),
            (this.color = this.color || h[a.colorCounter]),
            (h = h.length),
            (f = a.colorCounter),
            a.colorCounter++,
            a.colorCounter === h && (a.colorCounter = 0))
          : (f = a.colorIndex);
      ...
      applyOptions: function (a, h) {
        ...
        void 0 === this.x &&
          e &&
          (this.x = void 0 === h ? e.autoIncrement(this) : h);
        return this;
      },
      optionsToObject: function (a) {
        ...
        if (n(a) || null === a) e[c[0]] = a;
          ...
          for (
            ...
            a.length > b &&
            ((f = typeof a[0]),
            "string" === f ? (e.name = a[0]) : "number" === f && (e.x = a[0]),
            k++);
            l < b;
      ...
      destroyElements: function () {
        for (
          ...
          (h = a[f]), this[h] && (this[h] = this[h].destroy());
      },
      ...
      },
      {
        ...
        autoIncrement: function () {
          ...
          e &&
            ((b = new l(c)),
            "day" === e
              ? (b = +b[l.hcSetDate](b[l.hcGetDate]() + d))
              : "month" === e
              ? (b = +b[l.hcSetMonth](b[l.hcGetMonth]() + d))
              : "year" === e &&
                (b = +b[l.hcSetFullYear](b[l.hcGetFullYear]() + d)),
            l.hcHasTimeZone && (g = a.getTZOffset(b) - a.getTZOffset(c)),
            (d = b - c + g));
          this.xIncrement = c + d;
          return c;
        },
        setOptions: function (a) {
          ...
          this.stickyTracking = I(
            a.stickyTracking,
            g[this.type] && g[this.type].stickyTracking,
            g.series && g.series.stickyTracking,
        ...
        getColor: function () {
          this.options.colorByPoint
            ...
            : this.getCyclic(
                "color",
                this.options.color || n[this.type].color,
        ...
        setData: function (d, e, h, f) {
          ...
          if (
            ...
            if (p && l > p) {
              ...
              if (b(x))
                for (h = 0; h < l; h++)
                  (z[h] = this.autoIncrement()), (F[h] = d[h]);
              else if (c(x))
                if (C)
                  for (h = 0; h < l; h++)
                    (x = d[h]), (z[h] = x[0]), (F[h] = x.slice(1, C + 1));
                else
                  for (h = 0; h < l; h++)
                    (x = d[h]), (z[h] = x[0]), (F[h] = x[1]);
              else a.error(12);
            } else
              for (h = 0; h < l; h++)
                void 0 !== d[h] &&
                  ((x = { series: g }),
                  g.pointClass.prototype.applyOptions.apply(x, [d[h]]),
                  g.updateParallelArrays(x, h));
        ...
        processData: function (b) {
          ...
          var l = this.getExtremesFromAll || m.getExtremesFromAll,
            ...
            p,
            z;
          if (t && !this.isDirty && !q.isDirty && !this.yAxis.isDirty && !b)
            return !1;
          q && ((b = q.getExtremes()), (p = b.min), (z = b.max));
          if (t && this.sorted && !l && (!f || e > f || this.forceCrop))
            if (c[e - 1] < p || c[0] > z) (c = []), (d = []);
            else if (c[0] < p || c[e - 1] > z)
              (g = this.cropData(this.xData, this.yData, p, z)),
                (c = g.xData),
                (d = g.yData),
                (g = g.start),
                (k = !0);
          for (f = c.length || 1; --f; )
            (e = x ? m(c[f]) - m(c[f - 1]) : c[f] - c[f - 1]),
              0 < e && (void 0 === h || e < h)
                ? (h = e)
        ...
        generatePoints: function () {
          ...
          for (n = 0; n < h; n++)
            (m = f + n),
              l
                ? ((t = new k().init(this, [g[n]].concat(K(e[n])))),
                  (t.dataGroup = this.groupMap[n]))
                : (t = c[m]) ||
                  void 0 === b[m] ||
                  (c[m] = t = new k().init(this, b[m], g[n])),
              t && ((t.index = m), (x[n] = t));
          this.options.keys = a;
          if (c && (h !== (d = c.length) || l))
            for (n = 0; n < d; n++)
              n !== f || l || (n += h),
                c[n] && (c[n].destroyElements(), (c[n].plotX = void 0));
          this.data = c;
          this.points = x;
        },
        getExtremes: function (a) {
          ...
          for (n = 0; n < k; n++)
            if (
              ...
              (m =
                (b(t, !0) || c(t)) &&
                (!d.positiveValuesOnly || t.length || 0 < t)),
              (l =
          ...
          for (a = 0; a < h; a++) {
            ...
            B.plotX = p = f(
              Math.min(
                Math.max(
                  -1e5,
                  d.translate(N, 0, 0, 0, 1, l, "flags" === this.type)
                ),
                1e5
              )
            );
            c &&
              ...
              D &&
              D[N] &&
              ((r = this.getStackIndicator(r, N, this.index)),
              (E = D[N]),
              (K = E.points[r.key]),
              (z = K[0]),
              (K = K[1]),
              z === x && r.key === D[N].base && (z = I(n, g.min)),
              g.positiveValuesOnly && 0 >= z && (z = null),
              (B.total = B.stackTotal = E.total),
              (B.percentage = E.total && (B.y / E.total) * 100),
              (B.stackY = K),
              E.setOffset(this.pointXOffset || 0, this.barW || 0));
            B.yBottom = w(z) ? g.translate(z, 0, 1, 0, 1) : null;
            m && (K = this.modifyValue(K, B));
            B.plotY = z =
              "number" === typeof K && Infinity !== K
                ? Math.min(Math.max(-1e5, g.translate(K, 0, 1, 0, 1)), 1e5)
                : void 0;
            B.isInside =
              void 0 !== z && 0 <= z && z <= g.len && 0 <= p && p <= d.len;
            B.clientX = t ? f(d.translate(N, 0, 0, 0, 1, l)) : p;
            B.negative = B.y < (n || 0);
            B.category = e && void 0 !== e[B.x] ? e[B.x] : B.x;
            B.isNull ||
              (void 0 !== C && (u = Math.min(u, Math.abs(p - C))), (C = p));
        ...
        setClip: function (a) {
          ...
          !1 !== c.clip &&
            (this.group.clip(a || e ? f : b.clipRect),
        ...
        animate: function (a) {
          ...
          a
            ...
            : ((d = this.sharedClipKey),
              (a = b[d]) && a.animate({ width: b.plotSizeX, x: 0 }, c),
              b[d + "m"] &&
                b[d + "m"].animate({ width: b.plotSizeX + 99, x: 0 }, c),
              (this.animate = null));
        },
        ...
        drawPoints: function () {
          var a = this.points,
            ...
            n = I(
              ...
              this.closestPointRangePx >= 2 * k.radius
            );
          if (!1 !== k.enabled || this._hasPointMarkers)
            for (c = 0; c < a.length; c++)
              (d = a[c]),
                ...
                (l = d.isInside),
                g && !d.isNull
                  ? ((g = I(h.symbol, this.symbol)),
                    (d.hasImage = 0 === g.indexOf("url")),
                    (t = this.markerAttribs(d, d.selected && "select")),
                    e
                      ? e[l ? "show" : "hide"](!0).animate(t)
                      : l &&
                        (0 < t.width || d.hasImage) &&
                        (d.graphic = e = b.renderer
                          .symbol(g, t.x, t.y, t.width, t.height, f ? h : k)
                          .add(m)),
                    e && e.attr(this.pointAttribs(d, d.selected && "select")),
                    e && e.addClass(d.getClassName(), !0))
                  : e && (d.graphic = e.destroy());
        },
        ...
        pointAttribs: function (a, b) {
          ...
          b &&
            ...
            (d = I(
              b.lineWidth,
              c.lineWidth,
              d + I(b.lineWidthPlus, c.lineWidthPlus, 0)
            )),
        ...
        destroy: function () {
          ...
          u(a.axisTypes || [], function (b) {
            (f = a[b]) &&
              f.series &&
              (e(f.series, a), (f.isDirty = f.forceRedraw = !0));
          });
        ...
        drawGraph: function () {
          ...
          u(d, function (d, e) {
            var g = d[0],
              k = a[g];
            k
              ? ((k.endX = a.preventGraphAnimation ? null : c.xMap),
                k.animate({ d: c }))
              : c.length &&
                ...
                (k = a[g].attr(k).shadow(2 > e && b.shadow)));
        ...
        applyZones: function () {
          ...
          d.length &&
            ...
            u(d, function (d, g) {
              ...
              k = Math.min(
                Math.max(Math.round(n.toPixels(I(d.value, x.max), !0)), 0),
                t
              );
              ...
              B = Math.max(e, k);
              n.isXAxis
                ? ((f = { x: z ? B : w, y: 0, width: r, height: t }),
                  C || (f.x = b.plotHeight - f.x))
                : ((f = { x: 0, y: z ? B : w, width: t, height: r }),
                  C && (f.y = b.plotWidth - f.y));
              z &&
                c.isVML &&
                (f = n.isXAxis
                  ? { x: 0, y: p ? w : B, height: f.width, width: b.chartWidth }
                  : {
              ...
              h[g]
                ? h[g].animate(f)
                : ((h[g] = c.clipRect(f)),
                  m && a["zone-graph-" + g].clip(h[g]),
                  l && a["zone-area-" + g].clip(h[g]));
              K = d.value > x.max;
            }),
            (this.clips = h));
        },
  ...
  (function (a) {
    ...
    a.StackItem.prototype = {
      ...
      setOffset: function (a, h) {
        ...
        if ((h = this.label))
          h.align(this.alignOptions, null, c),
            (c = h.alignAttr),
            h[
    ...
    D.prototype.getStacks = function () {
      ...
      l(a.series, function (e) {
        !e.options.stacking ||
          ...
          (e.stackKey = e.type + w(e.options.stack, ""));
      });
    };
    E.prototype.buildStacks = function () {
      ...
      if (!this.isXAxis) {
        ...
        for (d = f; d--; ) a[h ? d : f - d - 1].setStackedPoints();
      ...
      if (
        ...
        for (G = 0; G < d; G++)
          (g = e[G]),
            ...
            t[A][g] ||
              (C[A] && C[A][g]
                ? ((t[A][g] = C[A][g]), (t[A][g].total = null))
                : (t[A][g] = new a.StackItem(
                    u,
                    u.options.stackLabels,
                    q,
                    g,
                    l
                  ))),
            (A = t[A][g]),
            null !== v
              ? ((A.points[F] = A.points[this.index] = [w(A.cumulative, k)]),
                p(A.cumulative) || (A.base = F),
                (A.touched = u.stacksTouched),
                0 < N.index &&
                  !1 === this.singleStacks &&
                  (A.points[F][0] = A.points[this.index + "," + g + ",0"][0]))
            ...
            "percent" === c
              ? ((q = q ? n : r),
                x && t[q] && t[q][g]
                  ? ((q = t[q][g]),
                    (A.total = q.total =
                      Math.max(q.total, A.total) + Math.abs(v) || 0))
                  : (A.total = H(A.total + (Math.abs(v) || 0))))
              : (A.total = H(A.total + (v || 0))),
            (A.cumulative = w(A.cumulative, k) + (v || 0)),
            null !== v &&
              (A.points[F].push(A.cumulative), (f[G] = A.cumulative));
  ...
  (function (a) {
    ...
    w(a.Chart.prototype, {
      addSeries: function (a, b, c) {
        ...
        a &&
          ((b = k(b, !0)),
          u(e, "addSeries", { options: a }, function () {
            d = e.initSeries(a);
            e.isDirtyLegend = !0;
            e.linkSeries();
            b && e.redraw(c);
      ...
      update: function (a, d, f) {
        ...
        if (t) {
          ...
          "alignTicks" in t && (x = !0);
          b(t, function (a, b) {
            -1 !== e("chart." + b, m.propsRequireUpdateSeries) && (g = !0);
            -1 !== e(b, m.propsRequireDirtyBox) && (m.isDirtyBox = !0);
          });
        ...
        r("xAxis yAxis zAxis series colorAxis pane".split(" "), function (b) {
          a[b] &&
            (r(K(a[b]), function (a, c) {
              (c = (l(a.id) && m.get(a.id)) || m[b][c]) &&
                c.coll === b &&
        ...
        g &&
          r(m.series, function (a) {
            a.update({}, !1);
          });
        a.loading && c(!0, m.options.loading, a.loading);
        x = t && t.width;
        t = t && t.height;
        (h(x) && x !== m.chartWidth) || (h(t) && t !== m.chartHeight)
          ? m.setSize(x, t)
          : k(d, !0) && m.redraw();
      },
    ...
    w(z.prototype, {
      update: function (a, b, c, d) {
        function e() {
          ...
          "point" === t.legendType && (n.isDirtyLegend = !0);
          b && n.redraw(c);
        }
        var h = this,
          f = h.series,
    ...
    w(B.prototype, {
      addPoint: function (a, b, c, d) {
        ...
        x = m.x;
        q = t.length;
        if (this.requireSorting && x < t[q - 1])
          for (n = !0; q && t[q - 1] > x; ) q--;
        ...
        c &&
          (h[0] && h[0].remove
            ? h[0].remove(!1)
            : (h.shift(), this.updateParallelArrays(m, "shift"), l.shift()));
      ...
      update: function (a, b) {
        ...
        a = c(
          h,
          x,
          { index: d.index, pointStart: d.xData[0] },
          { data: d.options.data },
          a
        );
        d.remove(!1, null, !1);
    ...
    w(H.prototype, {
      ...
      remove: function (a) {
        for (
          var b = this.chart, c = this.coll, e = this.series, h = e.length;
          h--;
      ...
      { softThreshold: !1, threshold: 0 },
      {
        ...
        getStackPoints: function (f) {
          var l = [],
            ...
            b = c.length,
            k,
            z = p(e.options.reversedStacks, !0) ? 1 : -1,
            B;
          f = f || this.points;
          if (this.options.stacking) {
            for (B = 0; B < f.length; B++)
              (f[B].leftNull = f[B].rightNull = null), (m[f[B].x] = f[B]);
        ...
        getGraphPath: function (a) {
          var l = f.prototype.getGraphPath,
            ...
            K = function (h, f, l) {
              ...
              var x,
                ...
                m = !0;
              l || n
                ? ((x = (n ? h[0] : h[1]) + l), (t = h[0] + l), (m = !!n))
                : !u && a[f] && a[f].isNull && (x = t = B);
              void 0 !== x &&
                (c.push({
                  plotX: k,
          ...
          for (h = 0; h < a.length; h++)
            if (
              ((m = a[h].isNull),
              (k = p(a[h].rectPlotX, a[h].plotX)),
              (x = p(a[h].yBottom, I)),
              !m || r)
            )
              r || K(h, h - 1, "left"),
                (m && !u && r) ||
                  (c.push(a[h]), d.push({ x: h, plotX: k, plotY: x })),
                r || K(h, h + 1, "right");
          h = l.call(this, c, !0, !0);
          d.reversed = !0;
          m = l.call(this, d, !0, !0);
        ...
        drawGraph: function () {
          ...
          var a = this,
            l = this.areaPath,
            w = this.options,
            u = [["area", "highcharts-area", this.color, w.fillColor]];
          D(this.zones, function (e, h) {
            u.push([
              "zone-area-" + h,
              "highcharts-area highcharts-zone-area-" + h + " " + e.className,
              e.color || a.color,
              e.fillColor || w.fillColor,
            ]);
          });
          D(u, function (e) {
            var h = e[0],
            ...
            f
              ? ((f.endX = a.preventGraphAnimation ? null : l.xMap),
                f.animate({ d: l }))
              : ((f = a[h] = a.chart.renderer
                  .path(l)
                  .addClass(e[1])
                  .attr({
                    fill: p(
                      e[3],
                      E(e[2]).setOpacity(p(w.fillOpacity, 0.75)).get()
                    ),
                    zIndex: 0,
                  })
                  .add(a.group)),
      ...
      {},
      {
        getPointSpline: function (a, H, p) {
          ...
          if (
            ...
            e += h;
            w > a && w > l
              ? ((w = Math.max(a, l)), (e = 2 * l - w))
              : w < a && w < l && ((w = Math.min(a, l)), (e = 2 * l - w));
            e > p && e > l
              ? ((e = Math.max(p, l)), (w = 2 * l - e))
              : e < p && e < l && ((e = Math.min(p, l)), (w = 2 * l - e));
            H.rightContX = u;
            H.rightContY = e;
          }
          H = [
            "C",
            E(r.rightContX, r.plotX),
            E(r.rightContY, r.plotY),
            E(n, f),
            E(w, l),
            f,
            l,
      ...
      },
      {
        ...
        getColumnMetrics: function () {
          ...
          var n = Math.min(
            ...
            x = (n - 2 * p) / (l || 1),
            h = Math.min(
              h.maxPointWidth || f.len,
              r(h.pointWidth, x * (1 - 2 * h.pointPadding))
            );
          a.columnMetrics = {
            width: h,
            offset:
              (x - h) / 2 +
              (p + ((a.columnIndex || 0) + (c ? 1 : 0)) * x - n / 2) *
                (c ? -1 : 1),
          };
        ...
        translate: function () {
          ...
          H(a.points, function (d) {
            ...
            l &&
              Math.abs(g) < l &&
              ((g = l),
              (p = (!c.reversed && !d.negative) || (c.reversed && d.negative)),
              d.y === b && a.dataMax <= b && c.min < b && (p = !p),
              (t = Math.abs(t - k) > l ? e - l : k - (p ? l : 0)));
            d.barX = m;
            d.pointWidth = u;
            d.tooltipPos = h.inverted
              ? [c.len + c.pos - h.plotLeft - f, a.xAxis.len - m - n / 2, g]
              : [m + n / 2, f + c.pos - h.plotTop, g];
            d.shapeType = "rect";
            d.shapeArgs = a.crispCol.apply(
              a,
              d.isNull ? [m, k, n, 0] : [m, t, n, g]
            );
          });
        },
        getSymbol: a.noop,
        ...
        pointAttribs: function (a, f) {
          ...
          a &&
            this.zones.length &&
            ((k = a.getZone()),
            (k = a.options.color || (k && k.color) || this.color));
          f &&
            ((a = l(
              e.states[f],
            ...
            (k =
              a.color ||
              (void 0 !== f && D(k).brighten(a.brightness).get()) ||
              k),
            (h = a[d] || h),
            (n = a[b] || n),
            (c = a.dashStyle || c));
          d = { fill: k, stroke: h, "stroke-width": n };
          c && (d.dashstyle = c);
          return d;
        },
        drawPoints: function () {
          ...
          H(a.points, function (e) {
            ...
            if (f(e.plotY) && null !== e.y) {
              ...
              k.attr(a.pointAttribs(e, e.selected && "select")).shadow(
                m.shadow,
                null,
          ...
          u &&
            (a
              ? ((b.scaleY = 0.001),
                (a = Math.min(
                  f.pos + f.len,
                  Math.max(f.pos, f.toPixels(d.threshold))
                )),
                c ? (b.translateX = a - f.len) : (b.translateY = a),
                e.group.attr(b))
              : ((l = e.group.attr(k)),
                e.group.animate(
                  { scaleY: 1 },
    ...
    h(
      ...
      },
      {
          ...
          a ||
            (p(b, function (a) {
              var b = a.graphic,
                e = a.shapeArgs;
              b &&
                (b.attr({ r: a.startR || c.center[3] / 2, start: d, end: d }),
                b.animate(
        ...
        updateTotals: function () {
          ...
          for (a = 0; a < e; a++)
            (f = b[a]), (c += h && !f.visible ? 0 : f.isNull ? 0 : f.y);
          this.total = c;
          for (a = 0; a < e; a++)
            (f = b[a]),
              (f.percentage = 0 < c && (f.visible || !h) ? (f.y / c) * 100 : 0),
              (f.total = c);
        },
        generatePoints: function () {
        ...
        translate: function (a) {
          ...
          for (r = 0; r < F; r++) {
            ...
            h = (Math.cos(m) * a[2]) / 2;
            u = (Math.sin(m) * a[2]) / 2;
            G.tooltipPos = [a[0] + 0.7 * h, a[1] + 0.7 * u];
            G.half = m < -Math.PI / 2 || m > Math.PI / 2 ? 1 : 0;
            G.angle = m;
            f = Math.min(e, G.labelDistance / 5);
            G.labelPos = [
              a[0] + h + Math.cos(m) * G.labelDistance,
              a[1] + u + Math.sin(m) * G.labelDistance,
              a[0] + h + Math.cos(m) * f,
              a[1] + u + Math.sin(m) * f,
              a[0] + h,
              a[1] + u,
        ...
        drawPoints: function () {
          ...
          p(a.points, function (d) {
            ...
            if (d.isNull) e && (d.graphic = e.destroy());
              ...
              e
                ? e.setRadialReference(a.center).attr(h).animate(f(l, b))
                : ((d.graphic = e = c[d.shapeType](l)
                    .setRadialReference(a.center)
                    .attr(b)
                    .add(a.group)),
                  d.visible || e.attr({ visibility: "hidden" }),
                  e.attr(h).attr({ "stroke-linejoin": "round" }).shadow(m, k));
      ...
      },
      {
        ...
        setVisible: function (a, c) {
          ...
          a !== b.visible &&
            ...
            (d.options.data[r(b, d.data)] = b.options),
            p(["graphic", "dataLabel", "connector", "shadowGroup"], function (
              c
            ) {
              if (b[c]) b[c][a ? "show" : "hide"](!0);
            }),
            b.legendItem && e.legend.colorizeItem(b, a),
        ...
        haloPath: function (a) {
          ...
          return this.sliced || !this.visible
            ...
            : this.series.chart.renderer.symbols.arc(
                ...
                c.r + a,
                c.r + a,
                { innerR: this.shapeArgs.r - 1, start: c.start, end: c.end }
              );
        },
      }
    );
  ...
  (function (a) {
        ...
        for (e = a.length; e--; )
          (f = a[e]),
            (m =
              ...
              2),
            (f.pos = Math.min(Math.max(0, m - f.size * f.align), b - f.size));
        e = a.length;
        for (f = !1; e--; )
          0 < e &&
            ...
            (a[e - 1].align = 0.5),
            a[e - 1].pos + a[e - 1].size > b &&
              (a[e - 1].pos = b - a[e - 1].size),
            a.splice(e, 1),
            (f = !0));
      }
      e = 0;
    ...
    h.prototype.drawDataLabels = function () {
      ...
      var b = this,
        ...
        t,
        w,
        D = u(e.defer, !!d.animation),
        q = b.chart.renderer;
      if (e.enabled || b._hasPointLabels)
        b.dlProcessOptions && b.dlProcessOptions(e),
          (w = b.plotGroup(
            "dataLabelsGroup",
            "data-labels",
            D && !r ? "hidden" : "visible",
          ...
          p(f, function (f) {
            ...
            (k = u(h && h.enabled, m.enabled) && !f.isNull) &&
              (k = !0 === c(f, h || e));
            k &&
              ((e = n(m, h)),
              (g = f.getLabelConfig()),
              (C = e[f.formatPrefix + "Format"] || e.format),
              (t = H(C)
                ? l(C, g)
                : (e[f.formatPrefix + "Formatter"] || e.formatter).call(g, e)),
              (C = e.style),
              (g = e.rotation),
              (C.color = u(e.color, C.color, b.color, "#000000")),
              "contrast" === C.color &&
                ((f.contrastColor = q.getContrast(f.color || b.color)),
                (C.color =
                  e.inside || 0 > u(f.labelDistance, e.distance) || d.stacking
                    ? f.contrastColor
                    : "#000000")),
            ...
            !p || (k && H(t))
              ? k &&
                ...
                (p
                  ? (x.text = t)
                  : ((p = f.dataLabel = g
                      ? q.text(t, 0, -9999).addClass("highcharts-data-label")
                      : q.label(
                          t,
                          0,
                          -9999,
                ...
                p.attr(x),
                p.css(C).shadow(e.shadow),
                p.added || p.add(w),
                b.alignDataLabel(f, p, e, null, z))
              : ((f.dataLabel = p = p.destroy()),
    ...
    h.prototype.alignDataLabel = function (a, b, d, e, h) {
      var c = this.chart,
        ...
        w =
          this.visible &&
          (a.series.forceDL ||
            c.isInsidePlot(l, Math.round(m), k) ||
            (e && c.isInsidePlot(l, k ? e.x + 1 : e.y + e.height - 1, k))),
        z = "justify" === u(d.overflow, "justify");
      if (
        w &&
        ((p = d.style.fontSize),
        (p = c.renderer.fontMetrics(p, b).b),
        (e = f(
          {
        ...
        q
          ? ((z = !1),
            (l = c.renderer.rotCorr(p, q)),
            (l = {
              x: e.x + d.x + e.width / 2 + l.x,
              y:
                e.y +
                d.y +
                { top: 0, middle: 0.5, bottom: 1 }[d.verticalAlign] * e.height,
            }),
            b[h ? "attr" : "animate"](l).attr({ align: r }),
            (m = (q + 720) % 360),
            (m = 180 < m && 360 > m),
            "left" === r
              ? (l.y -= m ? n.height : 0)
              ...
              : "right" === r && ((l.x -= n.width), (l.y -= m ? 0 : n.height)))
          : (b.align(d, null, e), (l = b.alignAttr)),
        z
          ? (a.isLabelJustified = this.justifyDataLabel(b, d, l, n, e, h))
          : u(d.crop, !0) &&
            (w =
              c.isInsidePlot(l.x, l.y) &&
              c.isInsidePlot(l.x + n.width, l.y + n.height)),
        d.shape && !q)
      )
        b[h ? "attr" : "animate"]({
    ...
    h.prototype.justifyDataLabel = function (a, b, d, e, f, h) {
      ...
      m = d.x + e.width - p;
      m > c.plotWidth &&
        ("left" === k ? (b.align = "right") : (b.x = c.plotWidth - m),
        (n = !0));
      m = d.y + p;
      0 > m &&
        ("bottom" === l ? (b.verticalAlign = "top") : (b.y = -m), (n = !0));
      m = d.y + e.height - p;
      m > c.plotHeight &&
        ("top" === l ? (b.verticalAlign = "bottom") : (b.y = c.plotHeight - m),
        (n = !0));
    ...
    m.pie &&
      ((m.pie.prototype.drawDataLabels = function () {
        ...
        c.visible &&
          ...
          h.prototype.drawDataLabels.apply(c),
          p(b, function (a) {
            a.dataLabel &&
              a.visible &&
              (E[a.half].push(a), (a.dataLabel._pos = null));
          }),
          p(E, function (b, h) {
            var k,
              m,
            ...
            if (x)
              for (
                c.sortByAngle(b, h - 0.5),
                  0 < c.maxLabelDistance &&
                    ((k = Math.max(0, A - q - c.maxLabelDistance)),
                    (m = Math.min(A + q + c.maxLabelDistance, e.plotHeight)),
                    p(b, function (a) {
                      0 < a.labelDistance &&
                        a.dataLabel &&
                        ((a.top = Math.max(0, A - q - a.labelDistance)),
                        (a.bottom = Math.min(
                          A + q + a.labelDistance,
                          e.plotHeight
                        )),
                ...
                (d = b[M]),
                  ...
                  (g = d.labelPos),
                  (F = d.dataLabel),
                  (J = !1 === d.visible ? "hidden" : "inherit"),
                  (P = k = g[1]),
                  r &&
                    H(r[m]) &&
                    (void 0 === r[m].pos
                      ? (J = "hidden")
                      : ((v = r[m].size), (P = d.top + r[m].pos))),
                  delete d.positionIndex,
                  (L = f.justify
                    ? w[0] + (h ? -1 : 1) * (q + d.labelDistance)
                    : c.getX(P < d.top + 2 || P > d.bottom - 2 ? k : P, h, d)),
                  (F._attr = { visibility: J, align: g[6] }),
                  (F._pos = {
                    x: L + f.x + ({ left: l, right: -l }[g[6]] || 0),
                    y: P + f.y - 10,
                  }),
                  (g.x = L),
                  (g.y = P),
                  u(f.crop, !0) &&
                    ...
                    L - G < l
                      ? ((k = Math.round(G - L + l)),
                        (y[3] = Math.max(k, y[3])))
                      : L + G > n - l &&
                        ((k = Math.round(L + G - n + l)),
                        (y[1] = Math.max(k, y[1]))),
                    0 > P - v / 2
                      ? (y[0] = Math.max(Math.round(-P + v / 2), y[0]))
                      : P + v / 2 > t &&
                        (y[2] = Math.max(Math.round(P + v / 2 - t), y[2])),
                    (F.sideOverflow = k));
          }),
          0 === D(y) || this.verifyDataLabelOverflow(y)) &&
      ...
      (m.pie.prototype.alignDataLabel = w),
      (m.pie.prototype.verifyDataLabelOverflow = function (a) {
        ...
        l ||
          ...
          h < b[2]
            ? ((b[2] = h),
              (b[3] = Math.min(e(c.innerSize || 0, h), h)),
              this.translate(b),
    ...
    m.column &&
      (m.column.prototype.alignDataLabel = function (a, b, d, e, f) {
        ...
        l &&
          ...
          p ||
            (c
              ? ((e.x += m ? 0 : e.width), (e.width = 0))
              : ((e.y += m ? e.height : 0), (e.height = 0))));
        d.align = u(d.align, !c || p ? "center" : m ? "right" : "left");
        d.verticalAlign = u(
          d.verticalAlign,
          c || p ? "middle" : m ? "top" : "bottom"
        );
      ...
      for (n = 0; n < f; n++)
        if ((p = a[n]))
          (p.oldOpacity = p.opacity),
            (p.newOpacity = 1),
            p.width ||
              ((w = p.getBBox()), (p.width = w.width), (p.height = w.height));
      a.sort(function (a, b) {
      ...
      for (n = 0; n < f; n++)
        for (w = a[n], p = n + 1; p < f; ++p)
          if (
            ...
            (w.labelrank < u.labelrank ? w : u).newOpacity = 0;
      D(a, function (a) {
        var b, c;
        a &&
          ((c = a.newOpacity),
    ...
    I = a.TrackerMixin = {
      ...
      drawTrackerGraph: function () {
        var a = this,
          ...
          p = "rgba(192,192,192," + (B ? 0.0001 : 0.002) + ")";
        if (e && !c)
          for (m = e + 1; m--; )
        ...
        !a || a.resetSelection
          ...
          : r(a.xAxis.concat(a.yAxis), function (a) {
              ...
              d[c.isXAxis ? "zoomX" : "zoomY"] &&
                ((b = c.zoom(a.min, a.max)), c.displayBtn && (e = !0));
            });
        f = this.resetZoomButton;
        e && !f
          ? this.showResetZoom()
          : !e && h(f) && (this.resetZoomButton = f.destroy());
        b &&
          this.redraw(
            c(
      ...
      select: function (a, b) {
        ...
        d.firePointEvent(
          ...
          function () {
            ...
            d.setState(a && "select");
            b ||
              r(h.getSelectedPoints(), function (a) {
                a.selected &&
                  a !== d &&
                  ((a.selected = a.options.selected = !1),
                  (f.options.data[e(a, f.data)] = a.options),
                  a.setState(""),
        ...
        if (
          ...
          if (this.graphic)
            this.state &&
              ...
              this.graphic.animate(
                ...
                c(w.options.chart.animation, h.animation)
              ),
              z &&
                this.graphic.animate(
                  z,
                  c(w.options.chart.animation, p.animation, k.animation)
                ),
              r && r.hide();
          else {
            if (a && p) {
              ...
              if (r) r[b ? "animate" : "attr"]({ x: z.x, y: z.y });
                ...
                k &&
                  ((f.stateMarkerGraphic = r = w.renderer
            ...
            r &&
              (r[a && w.isInsidePlot(d, e, w.inverted) ? "show" : "hide"](),
          ...
          (d = h.halo) && d.size
            ? (x ||
                (f.halo = x = w.renderer
                  .path()
                  .add((this.graphic || r).parentGroup)),
              x[b ? "animate" : "attr"]({ d: this.haloPath(d.size) }),
              x.attr({
                class:
                  "highcharts-halo highcharts-color-" +
                  c(this.colorIndex, f.colorIndex),
              }),
              (x.point = this),
              x.attr(
                n(
            ...
            : x &&
              x.point &&
              x.point.haloPath &&
              x.animate({ d: x.point.haloPath(0) });
          this.state = a;
        }
      },
      haloPath: function (a) {
        ...
        if (
          ...
          for (
            h = { "stroke-width": h },
              e.animate(
                h,
                c(b.chart.options.chart.animation, f[a] && f[a].animation)
              );
            b["zone-graph-" + d];
      ...
      function n(e, h, l, d) {
        ...
        a.objectEach(e, function (a, e) {
          if (!d && -1 < H(e, ["series", "xAxis", "yAxis"]))
            for (a = r(a), l[e] = [], c = 0; c < a.length; c++)
              h[e][c] && ((l[e][c] = {}), n(a[c], h[e][c], l[e][c], d + 1));
          else
            f(a)
              ? ((l[e] = p(a) ? [] : {}), n(a, h[e] || {}, l[e], d + 1))
              : (l[e] = h[e] || null);
        });
      }
      var u = {};
