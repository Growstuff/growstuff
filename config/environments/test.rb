...
Geocoder::Lookup::Test.add_stub('Amundsen-Scott Base, Antarctica', [{ 'coordinates' => [-90.0, 0.0] }])
...
Geocoder::Lookup::Test.add_stub('Greenwich, UK', [{ 'coordinates' => [51.483061, -0.004151] }])

Geocoder::Lookup::Test.add_stub('Edinburgh', [{ 'coordinates' => [55.953252, -3.188267] }])
